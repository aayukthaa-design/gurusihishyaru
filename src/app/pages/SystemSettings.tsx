...
import { Settings, Bell, Globe, Lock, Database, Mail, ShieldAlert, MessageSquare } from 'lucide-react';
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {SETTING_SECTIONS.map(({ icon: Icon, label, desc }) => (
            <button
              key={label}
              className="flex items-start gap-4 rounded-xl border border-border bg-card p-6 text-left transition-all hover:border-primary/40 hover:bg-secondary"
            >
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between border-b border-border pb-4 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Attendance WhatsApp Configuration</h3>
                <p className="text-xs text-muted-foreground mt-0.5">Manage automated alerts sent to parents for absences via WhatsApp.</p>
              </div>
            </div>
            {!isSuperAdmin && (
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="sm:col-span-2">
                <label className="flex cursor-pointer items-center gap-3 py-1.5">
                  ...
                  />
                  <div>
                    <span className="text-sm font-semibold text-foreground">Enable Attendance WhatsApp Alerts</span>
                    <p className="text-xs text-muted-foreground">Allows teachers to manually trigger WhatsApp messages to parents when a student is absent.</p>
                  </div>
                </label>
              </div>
